...
def generate_matrix(path_to_data, path_to_query):
    print('Started generating similarity matrices')
    ...
    for doc_data in get_clear_tokens(path_to_data):
        ...
        elif counter % 16000 == 0:
            print('NEARLY DONE! :)')
            #telegram.send('Damian', 'DAMI WCHODZ!!!!! JUZ PRAWWIE')
        counter += 1
    ...
    print('Matrices saved to /query/')



generate_matrix('/home/pepe/git/pacrr/relevant/*', '/home/pepe/git/pacrr/query/*')